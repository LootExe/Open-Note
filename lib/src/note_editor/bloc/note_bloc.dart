...
class NoteBloc extends ReplayBloc<NoteEvent, NoteState> {
  ...
  Future<void> _onNoteSaved(NoteSaved event, Emitter<NoteState> emit) async {
  ...
  void _onTextContentChanged(
      NoteTextContentChanged event, Emitter<NoteState> emit) {
    if (_cachedNote is! TextNote) {
      return;
    }
