...
///
/// To show the [RoundCheckboxListTile] as disabled, pass null as the [onChanged]
/// callback.
///
/// {@tool dartpad --template=stateful_widget_scaffold_center}
///
/// ![RoundCheckboxListTile sample](https://flutter.github.io/assets-for-api-docs/assets/material/checkbox_list_tile.png)
///
...
/// {@end-tool}
///
/// ## Semantics in RoundCheckboxListTile
///
/// Since the entirety of the RoundCheckboxListTile is interactive, it should represent
/// itself as a single interactive entity.
///
/// To do so, a RoundCheckboxListTile widget wraps its children with a [MergeSemantics]
/// widget. [MergeSemantics] will attempt to merge its descendant [Semantics]
/// nodes into one node in the semantics tree. Therefore, RoundCheckboxListTile will
/// throw an error if any of its children requires its own [Semantics] node.
///
/// For example, you cannot nest a [RichText] widget as a descendant of
/// RoundCheckboxListTile. [RichText] has an embedded gesture recognizer that
/// requires its own [Semantics] node, which directly conflicts with
/// RoundCheckboxListTile's desire to merge all its descendants' semantic nodes
...
/// {@end-tool}
///
/// ## RoundCheckboxListTile isn't exactly what I want
///
/// If the way RoundCheckboxListTile pads and positions its elements isn't quite
...
class RoundCheckboxListTile extends StatelessWidget {
  ...
  /// widgets in [RoundCheckboxListTile].
  ///
  ...
  /// If non-null, defines the background color when [RoundCheckboxListTile.selected] is true.
